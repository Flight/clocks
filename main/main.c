...
void app_main(void)
{
  ...
  // xTaskCreatePinnedToCore(&light_sensor_adc_task, "Light ADC Legacy", configMINIMAL_STACK_SIZE * 2, NULL, 1, NULL, 1);
  xTaskCreatePinnedToCore(&light_sensor_adc_oneshot_task, "Light ADC Oneshot", configMINIMAL_STACK_SIZE * 2, NULL, 1, NULL, 1);
